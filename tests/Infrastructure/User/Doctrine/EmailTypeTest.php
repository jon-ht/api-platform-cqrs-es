...
{
    public const TYPE = 'email_custom';
    ...
    public function given_an_email_type_with_an_invalid_value_then_it_should_throw_an_exception(): void
    {
        ...
        $this->type->convertToPHPValue(self::INVALID_VALUE, new MySqlPlatform());
    }
    ...
    public function given_an_email_then_it_should_return_string_value(): void
    {
        self::assertSame(
            'email@domain.com',
            $this->type->convertToDatabaseValue(Email::fromString('email@domain.com'), new MySqlPlatform())
        );
    }
